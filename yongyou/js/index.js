...
var index = {
	...
	headerSmall:function(){		
		...
		if(!$(this).is('.active')){
			...
			$('.div-wrapper').stop().animate({right:250},300)
//			$('.div-wrapper').css({'position':'fixed',top:-Top})
				$(this).css({
					background:'#D80A14'
				})
				...
				$('.small-menu').stop().animate({right:0},300)
				$(this).addClass('active')
				$('.bg-div').show()

		}else{
			divWrapper.removeEventListener('touchmove',prevent, { passive: false });
			$('body,html').css({'overflow':''})	
				$('.div-wrapper').stop().animate({right:0},300)
				$(this).css({
					background:'#fff'
				})
				$(this).find('.icon-bar').css({
				...
				$('.small-menu').stop().animate({right:'-300px'},300);
				samallMenulist.animate({right:'-300px'},300)
				$('.samall-menulists').animate({right:'-300px'},300)
		...
		mainA.click(function(){
			$(this).siblings().animate({right:'0'})
		})
		
		mainLis.on('click',function(){
			($(this).parent()).parent('.samall-menulists').animate({right:'-300px'},300);
		})
	},
	oneLunbo:function(){
	...
	push:function(){
		$('.domainCloud').find('.samall-menulists ul').append('<li><a title="营销服务" target="_blank" href="https://www.yonyoucloud.com/cloud_sales.html">用友云 | 营销服务</a></li>'+
														'<li><a title="采购服务" target="_blank" href="https://www.yonyoucloud.com/cloud_buy.html">用友云 | 采购服务</a></li>'+
														'<li><a title="协同服务" target="_blank" href="https://www.yonyoucloud.com/cloud_assist.html">用友云 | 协同服务</a></li>'+
														'<li><a title="财务服务" target="_blank" href="https://www.yonyoucloud.com/cloud_finance.html">用友云 | 财务服务</a></li>'+
														'<li><a title="人力服务" target="_blank" href="https://www.yonyoucloud.com/cloud_hr.html">用友云 | 人力服务</a></li>'+
														'<li><a title="工程服务" target="_blank" href="https://www.yonyoucloud.com/cloud_project.html">用友云 | 工程服务</a></li>'+
														'<li><a title="分析服务" target="_blank" href="https://www.yonyoucloud.com/cloud_analysis.html">用友云 | 分析服务</a></li>'+
														'<li><a title="U8 cloud" target="_blank" href="https://www.yonyoucloud.com/cloud_u8.html">U8 cloud</a></li>'+
														'<li><a title="税务服务" target="_blank" href="https://www.yonyoucloud.com/cloud_ebill.html">用友云 | 税务服务</a></li>'+
														'<li><a title="通信服务" target="_blank" href="https://www.yonyoucloud.com/cloud_connect.html">用友云 | 通信服务</a></li>')
		$('.industryCloud').find('.samall-menulists ul').append('<li><a title="用友建筑云" target="_blank" href="http://cc.yonyoucloud.com">用友建筑云</a></li>'+
		...
		$('.financeCloud').find('.samall-menulists ul').append('<li><a title="畅捷支付" target="_blank" href="http://chanpay.com/">畅捷支付</a></li>'+
		...
		$('.enterprise').find('.samall-menulists ul').append('<li><a title="支付结算" target="_blank" href="http://chanpay.com/site/pages/productCenter.html">支付结算</a></li>'+
																...
																'<li><a title="企业理财" target="_blank" href="http://www.yygold.com">企业理财</a></li>')
		$('.partner').find('.samall-menulists ul').append('<li><a title="云市场入驻" target="_blank" href="https://www.yonyoucloud.com/cooperativeEcology.html">云市场入驻</a></li>'+
																'<li><a title="加入合作伙伴" target="_blank" href="https://www.yonyoucloud.com/cooperativeEcology.html">加入合作伙伴</a></li>')				
	},
	widths:function(){
